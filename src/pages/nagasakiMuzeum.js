...
const NagasakiMuzeum = () => {
  return (
    <HiroshimaPage>
      <h2>
        Muzeum historyczne w Nagasaki w Japonii, poświęcone atakowi atomowemu na
        to miasto. Obok muzeum znajduje się Narodowa Sala Pamięci Pokoju Ofiar
        Bomby Atomowej w Nagasaki, zbudowana w 2003.
      </h2>
      <div className="text">
        ...
        oraz z atakiem jądrowym na Nagasaki i jego skutkami. Kiedy bomba została
        zrzucona 9 sierpnia 1945 o godzinie 11:02:35, 20 dzielnic w promieniu
        jednego kilometra od epicentrum zniszczyła wysoka temperatura i fala
        uderzeniowa wybuchu jądrowego. Dzieła zniszczenia dopełniły pożary.
        Zginęło co najmniej 70 tysięcy osób. Muzeum pokazuje, jak wyglądało
        miasto przed zniszczeniem. Zbiory obrazują skutki bombardowania; jest tu
        replika zniszczonej wybuchem frontowej ściany Katedry Urakami, która
        ...
        apele ocalonych, a także przeprowadzone działania ratownicze i pomocowe.
      </div>
